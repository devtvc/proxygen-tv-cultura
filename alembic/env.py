...
# can be acquired:
# my_important_option = config.get_my_important_option()
# ... etc.
...
def get_url():
    ...
    password = os.getenv("POSTGRES_PASSWORD", "broadcast_pass_123")
    host = os.getenv("POSTGRES_HOST", "postgres")
    port = os.getenv("POSTGRES_PORT", "5432")
    db = os.getenv("POSTGRES_DB", "broadcast_db")
